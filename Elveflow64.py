...
from ctypes import CDLL, c_int32, c_double, byref, c_char_p, c_uint16, c_uint16, POINTER, c_bool

ElveflowDLL=CDLL('U:/Flow_Cell_Leak_Test/Elveflow64.dll')  # change this path 
...
def M_S_R_D_Set_Filt (M_S_R_D_ID, Channel_1_to_4, ONOFF):
	...
	X_M_S_R_D_Set_Filt.argtypes=[c_int32, c_int32, c_bool]
